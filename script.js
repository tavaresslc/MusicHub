...
// Funções para Tocar e Pausar Músicas:
...
// Manipulação da Barra de Progresso pelo Usuário:
...
// Adição e Remoção de Músicas Curtidas:
...
// Adição de Música e Atualização da Lista de Reprodução:
...
// Adição de Música à Lista de Músicas no Perfil:
...
// Manipulação da Barra de Espaço para Reprodução:
...
// Eventos de Cliques e Atualizações:
